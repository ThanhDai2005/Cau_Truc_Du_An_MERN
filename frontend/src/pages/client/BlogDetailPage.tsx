...
// Hàm Helper lọc thẻ HTML cho thẻ Meta SEO
...
const BlogDetailPage = () => {
  ...
  const { currentBlog: article, loading, getDetail } = useBlogStore();
  ...
  // Tiền xử lý meta description an toàn
  const safeDescription = stripHtml(article.content).substring(0, 160) + "...";

  return (
    <>
      <Helmet>
        <title>{article.title} | Khám Phá Món Ngon FoodieVN</title>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 -mt-32 relative z-10">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-8 border border-gray-100">
            <span className="inline-block px-4 py-1.5 bg-red-50 text-[#b51c00] rounded-full text-xs font-bold uppercase tracking-wider mb-5 border border-red-100">
              {article.blogCategoryId?.name || "Tin Nổi Bật"}
            </span>
              ...
              <div className="flex items-center gap-3 font-medium">
                ...
                <div>
                  <p className="text-gray-900 font-bold">
                    {article.authorId?.displayName || "FoodieVN Editor"}
                  </p>
          ...
          {/* ================= RELATED PRODUCTS (Contextual Commerce) ================= */}
                    ...
                    >
                      ...
                      <div className="p-5 flex flex-col grow">
                        ...
                        <div className="mt-auto pt-4 border-t border-gray-200/60">
                          ...
                          {/* Quick Add Button an toàn, không vi phạm HTML */}
                          <button
                            onClick={(e) =>
                              handleQuickAdd(
                                e,
